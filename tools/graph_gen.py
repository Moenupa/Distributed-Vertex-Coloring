...
def parse_args():
    ...
    parser.add_argument('-v', '--n-vertex', type=int,
                        default=10, help='No. of Vertices (default: 1000)')
    parser.add_argument('-e', '--n-edge', type=int, default=10,
                        help='No. of Edges (default: 1000)')
